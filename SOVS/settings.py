"""
Django settings for SOVS project.
...
SECRET_KEY = 'django-insecure-fpim1((pz0g7&7@9r_06-_afx8z%pzqvc!q7iwi1jq6se2*b$)'
...
WSGI_APPLICATION = 'SOVS.wsgi.application'
